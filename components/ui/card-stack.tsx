...
export function CardStack<T extends CardStackItem>({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-pink-200/20 blur-3xl"
          aria-hidden="true"
        />
        <div
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-4 border-white/30 overflow-hidden shadow-2xl",
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-foreground w-5" : "bg-foreground/30 hover:bg-foreground/50",
                  )}
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-pink-50 text-sm text-muted-foreground">
            No image
          </div>
        )}
      </div>
